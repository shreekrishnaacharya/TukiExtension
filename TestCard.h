 ...
 *  Class definition
 */
class TestCard : public Php::Base {
private:
    /**
     *  @var Php::Value
     */
public:
    ...
    TestCard() {
        ...
        agreement += " Mr. Acharya and Eagle Eye according to the contract between them on date 2018 and its update. As long as the contract exists between Eagle Eye and Mr. Acharya, ";
